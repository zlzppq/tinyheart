...
function game()
{
    ...
    $(".btn1").on('click', function () {
        layer.msg("游戏说明：通过鼠标控制鱼妈妈，吃够足够能量碰一下鱼宝宝即可以喂食0^V^0，否则过一段时间鱼宝宝变白就死翘翘啦o(╥﹏╥)o,吃蓝色果实会增加倍数，吃黄色果实可以增加相应倍数的能量哟");
    });
    $(".btn2").on('click', function () {
        layer.msg("1：鼠标尽量别移动到游戏窗口外，因为这样操作是无效的，鱼妈妈不会跟着窗口外的鼠标走 2：感谢所有支持我的人，尤其，是你^V^jzt");
    });
